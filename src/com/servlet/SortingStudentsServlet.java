 ...
 */
@WebServlet("/sort-student")
public class SortingStudentsServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if("desc".equals(criteria)){
			Collections.reverse(profileVOs);
		}else{
			Collections.sort(profileVOs);
		}
